...
import { WhatsAppButton } from "@/components/sbc/WhatsAppButton";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sagar Burse Consulting (SBC)" },
      {
        name: "description",
        content:
          "MSME consulting, institution building, strategic research and policy advisory from Ahmedabad, Gujarat.",
      },
