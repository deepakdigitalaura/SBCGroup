...
const title = "Management Consulting Firms in Ahmedabad | SBC";
const description =
  "Compare management consulting firms in Ahmedabad. SBC is an implementation-led consultancy for MSMEs and institutions. Book a free business systems audit.";
...
const faqs: [string, string][] = [
  ...
  [
    "How do I choose the best consulting firm in Ahmedabad?",
  ...
  [
    "What makes SBC different from other consultancy companies in Ahmedabad?",
  ...
  [
    "How much do management consulting services cost in Ahmedabad?",
...
const webPageSchema = {
  ...
  name: "Management Consulting Firms in Ahmedabad | SBC",
  description:
    "Compare management consulting firms in Ahmedabad. SBC is an implementation-led consultancy for MSMEs and institutions. Book a free business systems audit.",
  inLanguage: "en-IN",
  isPartOf: {
...
const businessSchema = {
  ...
  description:
    "Sagar Burse Consulting (SBC) is a management consulting firm in Ahmedabad, Gujarat offering MSME consulting, institution building, strategic research and policy advisory.",
    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          description:
            "Systems, SOPs, accountability frameworks, HR and organisation design, change management and strategic roadmaps for manufacturing, trading and service businesses.",
      ...
      },
      {
        ...
        itemOffered: {
          ...
          description:
            "University and skill-centre set-up, AICTE/UGC compliance, NSDC/SSC affiliation, governance design and curriculum development.",
      ...
      },
      {
        ...
        itemOffered: {
          ...
          description:
            "Independent feasibility studies, market research and detailed project reports that validate a venture before capital is committed.",
      ...
      },
      {
        ...
        itemOffered: {
          ...
          description:
            "Policy research, regulatory frameworks and evidence-based advisory for government bodies and industry associations.",
      ...
      <main>
          ...
          <div className="shell">
            <Reveal as="section" className="max-w-3xl">
              ...
              <p className="mt-5 text-[17px] leading-relaxed text-paper/80">
                Sagar Burse Consulting (SBC) is an Ahmedabad consultancy company that helps MSMEs,
                institutions and government bodies fix business systems, build institutions and
                shape policy — and stays through implementation until results are measurable.
              </p>
              <p className="mt-4 text-[17px] leading-relaxed text-paper/80">
                This guide explains what management consulting firms in Ahmedabad do, how to compare
                the top consulting firms in Ahmedabad, and how SBC works with business owners.
              </p>
          ...
          <div className="shell">
            <Reveal as="section" className="max-w-3xl">
              ...
              <p className="mt-4 text-[17px] leading-relaxed text-charcoal">
                The right management consulting firm in Ahmedabad is the one that can show a
                documented method, real results with numbers, experience in your sector and — most
                importantly — a commitment to implementation after the report. Start with a low-risk
                first step, such as a free business systems audit, before you commit to a long
                engagement.
              </p>
              <nav aria-label="On this page" className="mt-6">
                ...
                <ul className="mt-3 flex flex-wrap gap-4">
                  <li>
                    <a
                      href="#what-firms-do"
                      className="text-[14px] font-semibold text-gold-deep transition-colors hover:text-gold"
                    >
            ...
            <Reveal as="section" className="mt-8">
              ...
              <dl className="mt-4 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="border border-ink-tint bg-card p-5">
                  ...
                  <dd className="mt-2 text-[15px] leading-relaxed text-charcoal">
                    MSME Consulting, Institution Building &amp; Skill Development, Strategic
                    Research &amp; Feasibility, Policy Advisory
                  </dd>
                </div>
                <div className="border border-ink-tint bg-card p-5">
                  <dt className="text-[12px] font-semibold uppercase tracking-[0.16em] text-gold">
            ...
            >
              ...
              <div>
                <p className="text-[17px] leading-relaxed text-charcoal">
                  Management consulting firms help owners, institutions and public bodies solve
                  structural problems that internal teams struggle to fix while running daily
                  operations — unclear roles, missing systems, weak accountability, slow decisions,
                  compliance gaps and stalled growth. A good firm finds the root cause, designs a
                  practical solution and supports the team in adopting it.
                </p>
                <p className="mt-4 text-[17px] leading-relaxed text-charcoal">
                  Business consulting firms in Ahmedabad typically offer some combination of these
                  services:
                </p>
                <ul className="mt-4 space-y-2">
                  <li className="flex gap-2 text-[15.5px] leading-relaxed text-charcoal">
                    ...
                    <span>Business diagnostics and gap analysis</span>
                  </li>
                  <li className="flex gap-2 text-[15.5px] leading-relaxed text-charcoal">
                    <span className="mt-2.5 h-1 w-1 shrink-0 rounded-full bg-gold-deep" />
                    <span>Systems, SOPs and process improvement</span>
                  </li>
                  <li className="flex gap-2 text-[15.5px] leading-relaxed text-charcoal">
                    <span className="mt-2.5 h-1 w-1 shrink-0 rounded-full bg-gold-deep" />
                    <span>Organisation design, HR frameworks and KRA/KPI systems</span>
                  </li>
                  <li className="flex gap-2 text-[15.5px] leading-relaxed text-charcoal">
                    <span className="mt-2.5 h-1 w-1 shrink-0 rounded-full bg-gold-deep" />
                    <span>Strategic planning and growth roadmaps</span>
                  </li>
                  <li className="flex gap-2 text-[15.5px] leading-relaxed text-charcoal">
                    <span className="mt-2.5 h-1 w-1 shrink-0 rounded-full bg-gold-deep" />
                    <span>Feasibility studies, market research and detailed project reports</span>
                  </li>
                  <li className="flex gap-2 text-[15.5px] leading-relaxed text-charcoal">
                    <span className="mt-2.5 h-1 w-1 shrink-0 rounded-full bg-gold-deep" />
                    <span>Institution set-up, regulatory compliance and policy advisory</span>
                  </li>
                </ul>
                <p className="mt-4 text-[17px] leading-relaxed text-charcoal">
                  The biggest difference between firms is not the list of services — it is the
                  delivery model. Some firms hand over a report and leave. Others, like SBC, work
                  alongside your team until the new systems are running. Knowing which model you
                  need saves months of time and avoids a report that never gets implemented.
                </p>
                <p className="mt-4 text-[17px] leading-relaxed text-charcoal">
                  {"Our article on "}
                  <a
          ...
          <div className="shell">
            <Reveal as="section" className="max-w-3xl">
              <h2
                ...
                className="font-display text-3xl font-semibold tracking-tight text-ink md:text-[2.5rem] scroll-mt-24"
              >
                How to Choose Among the Top Consulting Firms in Ahmedabad
              </h2>
              <p className="mt-4 text-[17px] leading-relaxed text-charcoal">
                Ranking lists rarely show how a firm actually works. Use these six criteria to
                compare business consulting firms in Ahmedabad on substance — including SBC.
              </p>
            </Reveal>
            <Reveal as="section" className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              <article className="border border-ink-tint bg-paper p-6 transition-colors hover:border-gold">
                ...
                <p className="mt-2 text-[15px] leading-relaxed text-charcoal">
                  A report is only the start. Ask who will be on the ground with your team after the
                  recommendations are delivered, and for how long.
                </p>
              </article>
              <article className="border border-ink-tint bg-paper p-6 transition-colors hover:border-gold">
                <span className="grid size-9 shrink-0 place-items-center rounded-full border border-gold text-[12px] font-semibold text-gold">
                ...
                <p className="mt-2 text-[15px] leading-relaxed text-charcoal">
                  Look for a named framework with clear phases and deliverables. SBC uses the
                  six-phase GAP360™ method: Diagnose, Align, Analyse, Design, Implement and Sustain.
                </p>
              </article>
              <article className="border border-ink-tint bg-paper p-6 transition-colors hover:border-gold">
                <span className="grid size-9 shrink-0 place-items-center rounded-full border border-gold text-[12px] font-semibold text-gold">
                ...
                <p className="mt-2 text-[15px] leading-relaxed text-charcoal">
                  Ask for case studies with before-and-after metrics and timelines, not only
                  testimonials. Good results are specific: on-time delivery, attrition, founder
                  hours freed.
                </p>
              </article>
              <article className="border border-ink-tint bg-paper p-6 transition-colors hover:border-gold">
                ...
                <p className="mt-2 text-[15px] leading-relaxed text-charcoal">
                  A manufacturer, a university and a government body need different expertise. Check
                  experience in your sector and with regulators such as AICTE, UGC or NSDC where
                  relevant.
                </p>
              </article>
              <article className="border border-ink-tint bg-paper p-6 transition-colors hover:border-gold">
                ...
                <p className="mt-2 text-[15px] leading-relaxed text-charcoal">
                  Find out whether the founder or a principal consultant works on your engagement,
                  or whether it is handed to junior staff after the sales meeting.
                </p>
              </article>
              <article className="border border-ink-tint bg-paper p-6 transition-colors hover:border-gold">
                <span className="grid size-9 shrink-0 place-items-center rounded-full border border-gold text-[12px] font-semibold text-gold">
                ...
                <p className="mt-2 text-[15px] leading-relaxed text-charcoal">
                  Prefer firms that let you test the fit first — for example a free audit or a
                  scoped diagnostic — before you commit to a long retainer.
                </p>
              </article>
            </Reveal>
        ...
        <section className="section-y border-b border-ink-tint">
          <div className="shell">
            ...
            >
              ...
              <div>
                <p className="text-[17px] leading-relaxed text-charcoal">
                  SBC was founded in Ahmedabad, Gujarat by Sagar Burse, PhD for organisations that
                  need more than a consultant’s report. Too many MSMEs, institutions and government
                  bodies receive recommendations that never get implemented. We work differently: we
                  diagnose the gap, design the fix and stay engaged until it delivers measurable
                  results.
                </p>
                <p className="mt-4 text-[17px] leading-relaxed text-charcoal">
                  {
            ...
            <div className="mt-8 grid gap-5 sm:grid-cols-2">
              <Reveal as="section">
                <PracticeAreaCard
                  ...
                  description="We do not leave after the report. We stay engaged until results are delivered and outcomes can be measured."
                />
              </Reveal>
              <Reveal as="section">
                <PracticeAreaCard
                  ...
                  description="Every engagement follows a defined method — GAP360™ for businesses and structured frameworks for institutions."
                />
              </Reveal>
              <Reveal as="section">
                <PracticeAreaCard
                  ...
                  description="8+ years across MSME consulting, institution building, strategic research and policy advisory."
                />
              </Reveal>
              <Reveal as="section">
                <PracticeAreaCard
                  ...
                  description="We build lasting relationships, not one-time engagements. Your success is our long-term commitment."
                />
              </Reveal>
            </div>
          </div>
          ...
          <div className="shell">
            <Reveal as="section" className="max-w-3xl">
              <h2
                ...
                className="font-display text-3xl font-semibold tracking-tight text-ink md:text-[2.5rem] scroll-mt-24"
              >
                Consulting Services in Ahmedabad and Across Gujarat
              </h2>
              <p className="mt-4 text-[17px] leading-relaxed text-charcoal">
                SBC’s four practice divisions cover the most common reasons organisations hire a
                consulting firm.
              </p>
            </Reveal>
            <div className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <Reveal as="section" className="h-full">
                <PracticeAreaCard
                  icon={School}
                  title="Institution Building & Skill Development"
          ...
          <div className="shell">
            <Reveal as="section" className="max-w-3xl">
              <h2
                ...
                className="font-display text-3xl font-semibold tracking-tight text-ink md:text-[2.5rem] scroll-mt-24"
              >
                The GAP360™ Method: How SBC Works With Ahmedabad Businesses
              </h2>
              <p className="mt-4 text-[17px] leading-relaxed text-charcoal">
                GAP360™ (Growth Acceleration Pathway 360°) is SBC’s flagship framework, developed by
                Sagar Burse, PhD through on-ground consulting with Indian MSMEs. It looks across
                operations, systems, people, process and strategy, and moves every engagement
              ...
              <ol className="divide-y divide-ink-tint border-t border-ink-tint">
                <li className="flex flex-col gap-3 py-6 sm:flex-row sm:items-start sm:gap-6">
                  ...
                  <p className="text-[15px] leading-relaxed text-charcoal sm:flex-1">
                    ...
                    management to identify critical gaps and estimate their rupee impact.
                  </p>
                </li>
                <li className="flex flex-col gap-3 py-6 sm:flex-row sm:items-start sm:gap-6">
                  <div className="flex shrink-0 items-center gap-3 sm:w-56">
                  ...
                  <p className="text-[15px] leading-relaxed text-charcoal sm:flex-1">
                    Findings are reviewed with leadership so everyone agrees on priorities before
                ...
                <li className="flex flex-col gap-3 py-6 sm:flex-row sm:items-start sm:gap-6">
                  ...
                  <p className="text-[15px] leading-relaxed text-charcoal sm:flex-1">
                    Root-cause mapping of every gap, producing a prioritised gap register with an
                    impact assessment.
                  </p>
                </li>
                <li className="flex flex-col gap-3 py-6 sm:flex-row sm:items-start sm:gap-6">
                  ...
                  <p className="text-[15px] leading-relaxed text-charcoal sm:flex-1">
                    SOPs, KRA/KPI frameworks, reporting structures and workflows built for adoption,
                    not just elegance.
                  </p>
                </li>
                <li className="flex flex-col gap-3 py-6 sm:flex-row sm:items-start sm:gap-6">
                ...
                <li className="flex flex-col gap-3 py-6 sm:flex-row sm:items-start sm:gap-6">
                  ...
                  <p className="text-[15px] leading-relaxed text-charcoal sm:flex-1">
                    30-60-90 day reviews, dashboards and performance cadences so results last beyond
                    the engagement.
                  </p>
                </li>
              </ol>
            ...
            <p className="mt-6 text-[15px] leading-relaxed text-charcoal">
              <a
                href="/gap360"
                className="inline-flex items-center gap-1.5 text-[12px] font-semibold uppercase tracking-[0.16em] text-gold-deep transition-colors hover:text-gold"
              >
        ...
        <section className="section-y border-b border-ink-tint bg-ink-wash">
          <div className="shell">
            <Reveal as="section" className="max-w-3xl">
              ...
              <p className="mt-4 text-[17px] leading-relaxed text-charcoal">
                Numbers matter more than adjectives. These outcomes come from SBC engagements and
                are published in full in our case studies.
              </p>
            </Reveal>
            <div className="mt-8 grid gap-6 md:grid-cols-2">
              <Reveal as="section" className="flex flex-col border border-ink-tint bg-paper p-6">
                ...
                <p className="mt-3 flex-1 text-[15px] leading-relaxed text-charcoal">
                  On-time delivery improved from 61% to 84%, material wastage fell by 18% and annual
                  cost savings crossed ₹15 lakh — delivered in 90 days for a company with 50–60
                  employees.
                </p>
                <div className="mt-4">
                  <a
              ...
              <Reveal as="section" className="flex flex-col border border-ink-tint bg-paper p-6">
                ...
                <p className="mt-3 flex-1 text-[15px] leading-relaxed text-charcoal">
                  ...
                  the founder’s time, with the accountability system live in 60 days.
                </p>
                <div className="mt-4">
                  <a
              ...
              <Reveal as="section" className="flex flex-col border border-ink-tint bg-paper p-6">
                ...
                <p className="mt-3 flex-1 text-[15px] leading-relaxed text-charcoal">
                  Attrition fell from 34% to 18% and the hiring cycle from 45 to 22 days after SBC
                  built the HR architecture from the ground up over six months.
                </p>
                <div className="mt-4">
                  <a
              ...
              <Reveal as="section" className="flex flex-col border border-ink-tint bg-paper p-6">
                ...
                <p className="mt-3 flex-1 text-[15px] leading-relaxed text-charcoal">
                  A 40-day independent feasibility study — including 46 structured SMB interviews
                  across Ahmedabad — sized the Gujarat target market at about 5.6 lakh enterprises
                  and returned a “Feasible” verdict, conditional on pre-launch actions.
                </p>
                <div className="mt-4">
                  <a
        ...
        <section className="section-y border-b border-ink-tint">
          <div className="shell">
            ...
            <Reveal as="section" className="mt-8 grid gap-8 md:grid-cols-2">
              <div>
                ...
                <ul className="mt-4 space-y-2">
                  <li className="flex gap-2 text-[15.5px] leading-relaxed text-charcoal">
                    <span className="mt-2.5 h-1 w-1 shrink-0 rounded-full bg-gold-deep" />
                    <span>Manufacturing and industrial businesses</span>
                  </li>
                  <li className="flex gap-2 text-[15.5px] leading-relaxed text-charcoal">
                    <span className="mt-2.5 h-1 w-1 shrink-0 rounded-full bg-gold-deep" />
                    <span>Trading and distribution companies</span>
                  </li>
                  <li className="flex gap-2 text-[15.5px] leading-relaxed text-charcoal">
                    <span className="mt-2.5 h-1 w-1 shrink-0 rounded-full bg-gold-deep" />
                    <span>Service businesses looking to scale</span>
                  </li>
                  <li className="flex gap-2 text-[15.5px] leading-relaxed text-charcoal">
                    <span className="mt-2.5 h-1 w-1 shrink-0 rounded-full bg-gold-deep" />
                    <span>Founders trapped in daily operations</span>
                  </li>
                  <li className="flex gap-2 text-[15.5px] leading-relaxed text-charcoal">
                    <span className="mt-2.5 h-1 w-1 shrink-0 rounded-full bg-gold-deep" />
                    <span>Businesses with HR and accountability gaps</span>
                  </li>
                  <li className="flex gap-2 text-[15.5px] leading-relaxed text-charcoal">
                    <span className="mt-2.5 h-1 w-1 shrink-0 rounded-full bg-gold-deep" />
                    <span>MSMEs planning expansion or new ventures</span>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="mt-4 space-y-2">
                  <li className="flex gap-2 text-[15.5px] leading-relaxed text-charcoal">
                    <span className="mt-2.5 h-1 w-1 shrink-0 rounded-full bg-gold-deep" />
                    <span>Universities and skill-development institutions</span>
                  </li>
                  <li className="flex gap-2 text-[15.5px] leading-relaxed text-charcoal">
                    <span className="mt-2.5 h-1 w-1 shrink-0 rounded-full bg-gold-deep" />
                  ...
                  <li className="flex gap-2 text-[15.5px] leading-relaxed text-charcoal">
                    <span className="mt-2.5 h-1 w-1 shrink-0 rounded-full bg-gold-deep" />
                    <span>Government bodies that need policy research</span>
                  </li>
                  <li className="flex gap-2 text-[15.5px] leading-relaxed text-charcoal">
                    <span className="mt-2.5 h-1 w-1 shrink-0 rounded-full bg-gold-deep" />
              ...
              <Reveal as="section" className="order-1">
                <div className="max-w-sm border-2 border-gold p-3 shadow-[12px_12px_0_0_var(--ink)]">
                  <img
                    ...
                    alt="Sagar Burse, PhD, Founder and Principal Consultant of Sagar Burse Consulting (SBC), a management consulting firm in Ahmedabad"
                    width={768}
                    height={768}
                    loading="lazy"
                    decoding="async"
          ...
          <div className="shell">
            <Reveal as="section" className="max-w-3xl">
              <h2
                ...
                className="font-display text-3xl font-semibold tracking-tight text-ink md:text-[2.5rem] scroll-mt-24"
              >
                Frequently Asked Questions About Consulting Firms in Ahmedabad
              </h2>
            </Reveal>
            <div className="mt-8 max-w-3xl space-y-4">
              <Reveal as="section" className="border border-ink-tint bg-card p-6">
                <h3 className="font-display text-lg font-semibold leading-snug text-ink">
                  What do management consulting firms in Ahmedabad do?
                </h3>
                <p className="mt-3 text-[15.5px] leading-relaxed text-charcoal">
                  Management consulting firms in Ahmedabad help businesses, institutions and
                  government bodies solve structural problems such as weak systems, unclear
                  accountability, stalled growth and compliance gaps. Services typically include
                  business diagnostics, process and systems design, organisation and HR design,
                  strategic planning, feasibility studies and policy advisory. The best firms also
              ...
              <Reveal as="section" className="border border-ink-tint bg-card p-6">
                ...
                <p className="mt-3 text-[15.5px] leading-relaxed text-charcoal">
                  Compare firms on six points: commitment to implementation, a documented method,
                  case studies with measurable results, relevant sector and regulatory experience,
                  senior involvement in your engagement and a low-risk first step such as a free
                  audit. Ranking lists of the top consulting firms in Ahmedabad rarely show these
                  details, so ask each firm directly.
                </p>
              </Reveal>
              <Reveal as="section" className="border border-ink-tint bg-card p-6">
                ...
                <p className="mt-3 text-[15.5px] leading-relaxed text-charcoal">
                  SBC is implementation-led: we stay with your team through execution until results
                  are delivered, rather than ending the engagement with a report. We use a
                  documented six-phase method, GAP360™, publish measurable case-study results, and
                  the free audit is a direct conversation with the founder, Sagar Burse, PhD.
                </p>
              </Reveal>
              <Reveal as="section" className="border border-ink-tint bg-card p-6">
                <h3 className="font-display text-lg font-semibold leading-snug text-ink">
                ...
                <p className="mt-3 text-[15.5px] leading-relaxed text-charcoal">
                  SBC works with MSMEs in manufacturing, trading, distribution and services;
                  universities and skill-development institutions; industry associations and public
                  sector undertakings; and government bodies. Published case studies include a
                  rubber and plastics manufacturer, an industrial components manufacturer, a trading
                  and distribution business and a proposed finance services venture in Ahmedabad.
                </p>
              </Reveal>
              <Reveal as="section" className="border border-ink-tint bg-card p-6">
                <h3 className="font-display text-lg font-semibold leading-snug text-ink">
                ...
                <p className="mt-3 text-[15.5px] leading-relaxed text-charcoal">
                  Cost depends on the scope, duration and team required, so most firms, including
                  SBC, do not publish a fixed price list. SBC begins with a free 45-minute audit
                  that ends with an honest assessment and a potential path forward. Any further
                  engagement is scoped with defined outcome milestones so you know what you are
                  paying for.
                </p>
              </Reveal>
              <Reveal as="section" className="border border-ink-tint bg-card p-6">
                ...
                <p className="mt-3 text-[15.5px] leading-relaxed text-charcoal">
                  It depends on the problem. SBC’s published case studies range from a 40-day
                  feasibility study and a 60-day systems and accountability build to a 90-day
                  full-cycle improvement, a six-month HR architecture project and a 15–20 week
                  institution-building engagement. A full GAP360™ diagnostic typically takes 2–4
                  weeks.
                </p>
              </Reveal>
              <Reveal as="section" className="border border-ink-tint bg-card p-6">
                ...
                <p className="mt-3 text-[15.5px] leading-relaxed text-charcoal">
                  It is a focused 45-minute conversation with Sagar Burse, PhD. In the first 10
                  minutes we listen to understand your business, in the next 20 we identify your two
                  or three most critical gaps, and in the final 15 we share an honest assessment and
                  a potential path forward. There is no commitment and no sales pitch.
                </p>
              </Reveal>
              <Reveal as="section" className="border border-ink-tint bg-card p-6">
                <h3 className="font-display text-lg font-semibold leading-snug text-ink">
                ...
                <p className="mt-3 text-[15.5px] leading-relaxed text-charcoal">
                  SBC is headquartered in Ahmedabad, Gujarat, and serves clients across Gujarat and
                  India. Published engagements include businesses in Gujarat, an Ahmedabad-based
                  venture and a skill-development institute with a national scope.
                </p>
              </Reveal>
              <Reveal as="section" className="border border-ink-tint bg-card p-6">
                <h3 className="font-display text-lg font-semibold leading-snug text-ink">
                ...
                <p className="mt-3 text-[15.5px] leading-relaxed text-charcoal">
                  Yes. SBC’s MSME consulting is built for founder-led businesses, including
                  companies with 25–60 employees where the owner is involved in every decision.
                  Typical outcomes include documented SOPs, clear KRA/KPI frameworks, reporting
                  structures and measurable improvements in delivery, attrition or founder time.
                </p>
              </Reveal>
              <Reveal as="section" className="border border-ink-tint bg-card p-6">
                <h3 className="font-display text-lg font-semibold leading-snug text-ink">
                ...
                <p className="mt-3 text-[15.5px] leading-relaxed text-charcoal">
                  GAP360™ (Growth Acceleration Pathway 360°) is SBC’s flagship diagnostic and
                  implementation framework. It examines operations, systems, people, process and
                  strategy, and moves through six phases — Diagnose, Align, Analyse, Design,
                  Implement and Sustain — with SBC working alongside your team until results are
                  achieved.
                </p>
              </Reveal>
              <Reveal as="section" className="border border-ink-tint bg-card p-6">
                ...
                <p className="mt-3 text-[15.5px] leading-relaxed text-charcoal">
                  ...
                  8128310116 or email consulting@sbcgroup.in. SBC is based in Ahmedabad, Gujarat,
                  and typically responds within 24 hours on business days.
                </p>
              </Reveal>
            </div>
          </div>
        ...
        >
          <div className="shell">
            <Reveal className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-[17px] leading-relaxed text-charcoal">
                A focused 45-minute conversation with Sagar Burse, PhD to find where your business
                is losing money, time and momentum. No commitment. No sales pitch.
              </p>
              <ul className="mx-auto mt-5 max-w-md space-y-2 text-left">
                <li className="flex gap-2 text-[15.5px] leading-relaxed text-charcoal">
                  <span className="mt-2.5 h-1 w-1 shrink-0 rounded-full bg-gold-deep" />
                  <span>45 minutes with the founder, Sagar Burse, PhD</span>
                </li>
                <li className="flex gap-2 text-[15.5px] leading-relaxed text-charcoal">
                  <span className="mt-2.5 h-1 w-1 shrink-0 rounded-full bg-gold-deep" />
                  <span>Your two or three most critical gaps identified</span>
                </li>
                <li className="flex gap-2 text-[15.5px] leading-relaxed text-charcoal">
                  <span className="mt-2.5 h-1 w-1 shrink-0 rounded-full bg-gold-deep" />
                  <span>An honest assessment and a potential path forward</span>
                </li>
              </ul>
              <a
                href="/book-free-audit"
              ...
              <p className="mt-6 text-[15px] leading-relaxed text-charcoal">
                ...
                . SBC is based in Ahmedabad, Gujarat.
              </p>
            </Reveal>
          </div>
        </section>
